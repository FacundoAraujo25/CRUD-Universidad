...
function fillTable(data) {
    ...
    data.forEach(course => {
        ...
        editCell.innerHTML = "<button class='editButton'> <box-icon name='edit' type='solid' color='#1f8fc3' ></box-icon> </button>"

        let deleteCell = row.insertCell(4);
        deleteCell.innerHTML = "<button class='deleteButton'> <box-icon type='solid' name='trash' color='#1f8fc3' ></box-icon> </button>"
